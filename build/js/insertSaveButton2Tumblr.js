(function() {
  var DATA_URL_BLUE_24, DATA_URL_GRAY_24, SELECTOR_POST_WRAPPER, TUMBLR_HOSTNAME, sendBackground, showKawpaaButton;
  ...
  showKawpaaButton = function(_$) {
    ...
    html = "<div class=\"post_control post-control-icon icon-kawpaa kawpaa-save-link\" title=\"Save to Kawpaa\" data-subview=\"Save to Kawpaa\" style=\"background-image: url(" + DATA_URL_GRAY_24 + ");\"></div>";
    return _$.find('.post_controls_inner').append(html);
  };
  ...
  $(document).on('click', '.kawpaa-save-link', function(e) {
    var _targetElement, imageUrl, params, permalink, title;
    e.preventDefault();
